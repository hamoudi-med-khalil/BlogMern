import {
  require_react_dom
} from "./chunk-IU4XOYRB.js";
import {
  __commonJS,
  __export,
  __toESM,
  require_react
} from "./chunk-4SFAGBAW.js";
...
var useSWRHandler = (_key, fetcher, config) => {
  ...
  const returnedData = keepPreviousData ? isUndefined(cachedData) ? (_laggyDataRef_current = laggyDataRef.current) != null ? _laggyDataRef_current : data : cachedData : data;
